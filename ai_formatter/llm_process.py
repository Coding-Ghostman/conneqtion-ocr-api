...
def currency_convertor(currency_1: str, currency_2: str, currency_value)-> str:
    """
    Gets the exchange rate between currency_1 and currency_2 using the alpha vantage api and converts currency_1 to currency_2 by 
    multiplying it with the obtained exchange rate.
    """
    alpha_vantage = AlphaVantageAPIWrapper(alphavantage_api_key= alpha_vantage_key)
    exchange_rate = alpha_vantage._get_exchange_rate(currency_1, currency_2)
    print(exchange_rate)
    exchange_rate = exchange_rate["Realtime Currency Exchange Rate"]["5. Exchange Rate"]
    final_currency = currency_value*float(exchange_rate)
...
# print(currency_get_format("Rs 100", "$ 250"))
# print(currency_convertor("USD", "INR", 60))

    
# print(date_format_processor("4th January 2024", "29th February 2024"))