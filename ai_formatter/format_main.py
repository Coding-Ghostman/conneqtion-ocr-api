...
def format_changer(
    ...
    if requested_delivery_date:
        ...
        print("*****************")
        print(old_dates_similarity_requested_delivery_dates)
    ...
    if actual_or_estimated:
        ...
        actual_or_estimated_num_value = float([num for num in final_actual_or_estimated_list if is_number(num)][0])
        # if actual_or_estimated_num_value:
        #     actual_or_estimated_num_value = actual_or_estimated_num_value[0]
